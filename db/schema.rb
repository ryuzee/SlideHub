...
ActiveRecord::Schema.define(version: 2018_11_03_222210) do
  ...
  create_table "custom_files", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "path", null: false
    t.string "description"
    t.index ["path"], name: "idx_custom_files_ukey", unique: true
  end

  create_table "featured_slides", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "slide_id", null: false
    t.datetime "created_at", null: false
